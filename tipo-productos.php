      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Listado de tipos de productos</h1>
          </div>
          ...
          <table class="table border table-hover">
            ...
            <?php if($aTiposProductos != 0): ?>
              <?php foreach($aTiposProductos as $tipoproducto): ?>
            <tr>
              <td><?php echo $tipoproducto->nombre; ?></td>
              <td style="width: 110px;"><a href="tipo-producto-formulario.php?id=<?php echo $tipoproducto->idtipoproducto; ?>"><i class="fas fa-search"></i></a></td>
            </tr>
           <?php endforeach; ?>
            <?php endif; ?>
          </table>
